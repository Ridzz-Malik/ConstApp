...
public class ListviewActivity extends BaseCompatActivity {
    ...
    private LayoutInflator.listViewAdapter listViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewAdapter = new LayoutInflator.listViewAdapter(ListviewActivity.this, beanClassArrayList);
